...
### input files generated by generators
#### prices.txt
ProductId,BidPrice,OfferPrice
#### trades.txt
ProductId,TradeId,Price,Book,Quantity,Side
#### marketdata.txt
ProductId,Price,Quantity,PricingSide
#### inquiries.txt
InquiryId,ProductId,Side,Quantity,Price,State(RECEIVED)
### output files
#### positions.txt
ProductId,Booki,Positioni,...,TOTAL,TOTALPosition
#### risk.txt
ProductId,PV01,Quantity
#### streaming.txt
ProductId,BidPrice,OfferPrice,BidQuantity,OfferQuantity (Price in 6 digit decimal-Show some difference)
#### allinquiries.txt
ProductId,InquiryId,Side,Quantity,Price(decimal),State(DONE)
#### execution.txt
ProductId,ExecutionId,PricingSide,PriceAtExecution(decimal),Quantity
#### gui.txt
TimeInMillisecond,ProductId,MidPrice,Spread
